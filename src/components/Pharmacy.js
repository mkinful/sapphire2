...
export const Pharmacy = () => {
    return (
        <div className="pharm">
          ...
          <h5 className="fill">Fill out the form below to pick up your prescriptions</h5>

          <Form className="form-section">
            <Form.Group className="form-group" controlId="pharmForm.ControlInput1">
            ...
            <Form.Group controlId="exampleForm.ControlTextarea1">
              <Form.Label className="h5">Questions about the medication?</Form.Label>
